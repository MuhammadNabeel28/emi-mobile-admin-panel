...
class StackedRouter extends _i1.RouterBase {
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i6.AdminView: (data) {
      ...
      return _i10.MaterialPageRoute<dynamic>(
        builder: (context) => _i6.AdminView(key: args.key),
        settings: data,
      );
    },
